...
module.exports = __webpack_require__(/*! C:\Users\ggaliano\Desktop\Sitmun3\sitmun3-frontend-gui\src\main\angular-library\src\main.ts */"L5We");
...
var DataTreeComponent = /** @class */ (function () {
    ...
    DataTreeComponent.prototype.drop = function (event) {
        ...
        if (!newSiblings)
            return;
        var insertIndex = newSiblings.findIndex(function (s) { return s.id === nodeAtDest.id; });
        // remove the node from its old place
        var node = event.item.data;
        var siblings = findNodeSiblings(changedData, node.id);
        var siblingIndex = siblings.findIndex(function (n) { return n.id === node.id; });
    ...
    DataTreeComponent.prototype.expandNodesById = function (flatNodes, ids) {
        ...
        return flatNodes.forEach(function (node) {
            if (idSet.has(node.id)) {
                _this.treeControl.expand(node);
                var parent_1 = _this.getParentNode(node);
                while (parent_1) {
                    _this.treeControl.expand(parent_1);
                    parent_1 = _this.getParentNode(parent_1);
                }
            }
        });
    };
    ...
    DataTreeComponent.prototype.onEditButtonClicked = function (id) {
        console.log(id);
    };
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvbWFpbi9hbmd1bGFyLWxpYnJhcnkvcHJvamVjdHMvc2l0bXVuLWZyb250ZW5kLWd1aS9zcmMvbGliL2J0bi1jaGVja2JveC1maWx0ZXIvYnRuLWNoZWNrYm94LWZpbHRlci5jb21wb25lbnQuY3NzIn0= */");
...
var BtnCheckboxFilterComponent = /** @class */ (function () {
    function BtnCheckboxFilterComponent() {
        this.filterSelectFormControl = new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required);
        this.text = '';
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<select matNativeControl    #filterSelect [formControl]=\"filterSelectFormControl\" (change)='onChange(filterSelect.value)'>\r\n    <option value=\"\">{{\"selectAll\" | translate}}</option>\r\n    <option value=\"true\">{{\"enabled\" | translate}}</option>\r\n    <option value=\"false\">{{\"disabled\" | translate}}</option>\r\n  </select>");
