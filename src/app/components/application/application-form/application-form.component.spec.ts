...
import { ApplicationService, RoleService, CartographyGroupService, TreeService } from 'dist/sitmun-frontend-core/';
...
describe('ApplicationFormComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [ApplicationService,RoleService, TreeService, CodeListService, CartographyGroupService,
