...
import { BackgroundService,CartographyGroupService, CartographyService, CodeListService,TranslationService } from 'dist/sitmun-frontend-core/';
...
describe('BackgroundLayersFormComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [BackgroundService, CartographyService, CodeListService,CartographyGroupService,TranslationService,
