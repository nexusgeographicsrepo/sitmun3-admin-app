...
import {  CartographyService, TerritoryService, CartographyGroupService, CartographyAvailabilityService } from '@sitmun/frontend-core';
...
describe('LayersFormComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [CartographyService, TerritoryService, CartographyGroupService, CartographyAvailabilityService, CodeListService,
