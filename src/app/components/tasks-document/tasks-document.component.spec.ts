...
import { CodeListService, TaskService,TranslationService,ResourceService,ExternalService, TaskTypeService } from 'dist/sitmun-frontend-core/';
...
describe('TasksDocumentComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [CodeListService,TaskService, TaskTypeService, TranslationService,ResourceService,ExternalService,
