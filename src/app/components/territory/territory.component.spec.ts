...
import { TerritoryService, UserService, RoleService, UserConfigurationService } from '@sitmun/frontend-core';
...
describe('TerritoryComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [TerritoryService, UserService, RoleService, CodeListService,UserConfigurationService,
